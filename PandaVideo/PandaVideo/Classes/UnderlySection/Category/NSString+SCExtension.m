...
+ (NSString *_Nullable)getIntervalWithTimeStr:(NSString *_Nullable)timeStr {
    ...
    NSInteger zonghms = 0;
    if (array.count == 3) {
        NSString *HH = [array sc_safeObjectAtIndex:0];
        NSString *MM= [array sc_safeObjectAtIndex:1];
        NSString *ss = [array sc_safeObjectAtIndex:2];
    ...
    if (array.count == 2) {
        ...
        NSString *MM= [array sc_safeObjectAtIndex:0];
        NSString *ss = [array sc_safeObjectAtIndex:1];
    ...
    if (array.count == 1) {
        NSString *ss = [array sc_safeObjectAtIndex:0];
        NSInteger s = [ss integerValue];
        zonghms = s;
    }
    //需要的在转 NSString类型
