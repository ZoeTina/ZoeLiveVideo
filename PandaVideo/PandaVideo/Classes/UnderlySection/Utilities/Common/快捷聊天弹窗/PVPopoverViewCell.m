...
@implementation PVPopoverViewCell
...
- (void)setStyle:(PopoverViewStyle)style {
    ...
    if (_style == PopoverViewStyleDefault) {
        [_button setTitleColor:[UIColor sc_colorWithHex:0x2AB4E4] forState:UIControlStateNormal];
    } else {
        [_button setTitleColor:[UIColor sc_colorWithHex:0x2AB4E4] forState:UIControlStateNormal];
    }
}
...
- (void)setAction:(PVPopoverAction *)popoverAction {
    [_button setImage:popoverAction.image forState:UIControlStateNormal];
    [_button setTitle:popoverAction.title forState:UIControlStateNormal];
    _button.titleEdgeInsets = popoverAction.image ? UIEdgeInsetsMake(0, PopoverViewCellTitleLeftEdge, 0, -PopoverViewCellTitleLeftEdge) : UIEdgeInsetsZero;
}
