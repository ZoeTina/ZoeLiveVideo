...
-(void)swipeRightView:(BOOL)animation{
    ...
    self.bgImageV.backgroundColor = [Utils colorWithHexString:@"2fcf6f"];
    //    [self.onOffBtn setImage:[UIImage imageNamed:@"onBtn"]];
    self.titleLabel.textColor = [Utils colorWithHexString:@"2fcf6f"];
